...
public class pictureBrowserFragment extends Fragment implements imageIndicatorListener {
    ...
    /**
     * this method of the imageIndicatorListerner interface helps in communication between the
     * fragment and the recyclerView Adapter. Each time an iten in the adapter is clicked the position
     * of that item is communicated in the fragment and the position of the viewPager is adjusted as follows.
