...
public class ChatUser implements Serializable,
    ...
    public long connectedAt;            //current connection time
    public long lastConnectedAt;        //last connection time
    public long disconnectedAt;         //disccnnection time
    ...
    */
    ...
    protected ChatUser(Parcel in) {
        ...
        this.disconnectedAt          = in.readLong();
        this.lastConnectedAt         = in.readLong();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeLong(connectedAt);
        dest.writeLong(disconnectedAt);
