...
public class ChatMessage {
    ...
    public ChatMessage(String localId, String id_from, String id_to, String message, String imageUrl, String sent_at, String seen, String type, boolean pending) {
    ...
    public static ChatMessage fromJson(JSONObject o) {
        return new ChatMessage(
                ...
                o.isNull("image_url") ? null : o.optString("image_url"),
